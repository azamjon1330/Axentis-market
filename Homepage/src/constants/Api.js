...
export const ENDPOINTS = {
  ...
  savedAddresses: (phone) => `/users/${phone}/addresses`,
  savedAddress: (phone, addressId) => `/users/${phone}/addresses/${addressId}`,
  ...
  promoCodesCompany: (companyId) => `/promo-codes/company/${companyId}`,
