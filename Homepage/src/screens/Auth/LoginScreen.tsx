...
const styles = StyleSheet.create({
  ...
  logoBox: {
    ...
    marginBottom: 14,
    ...Platform.select({
      web: { boxShadow: '0 4px 18px rgba(123,92,240,0.45)' } as any,
      default: { shadowColor: '#7B5CF0', shadowOpacity: 0.45, shadowRadius: 18, elevation: 8 },
    }),
  },
  ...
  card: {
    ...
    ...Platform.select({
      ...
      default: { shadowColor: '#000', shadowOpacity: 0.1, shadowRadius: 20, elevation: 5 },
    }),
  },
  tabBar: {
    flexDirection: 'row',
